"""
Django settings for cogni_42930 project.
...
WSGI_APPLICATION = 'cogni_42930.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cogni_42930 API",
    "DESCRIPTION": "API documentation for cogni_42930 App",
    "VERSION": "v1",
}
